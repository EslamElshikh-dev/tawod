...
if(fs.existsSync('assets/js/contact-conversion.js')){const js=fs.readFileSync('assets/js/contact-conversion.js','utf8');if(!js.includes('form_submit_attempt')||!js.includes('tawodLeadSubmitted'))errors.push('contact-conversion.js missing the submit-attempt flow');if(js.includes("track('generate_lead'")||js.includes("gtag('event', 'generate_lead'"))errors.push('contact-conversion.js must not count an unconfirmed lead')}
