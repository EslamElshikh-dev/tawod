...
const dimensions = {
  ...
  "images/projects/modon-eight-warehouses-01-v4.webp": [1200, 1596],
...
function renderContent(article, body) {
  ...
  return [
    ...
    `<img src="../../${article.image}" width="${dims[0]}" height="${dims[1]}" loading="lazy" decoding="async" fetchpriority="low" alt="${escapeHtml(article.imageAlt)}">`,
    body,
    "</article>",
